...
from librarytemplate import __version__
...
copyright = f"{date.today().year}, John Heintz"
author = "John Heintz"
...
# LinkCode
code_url = f"https://github.com/jheintz/librarytemplate/blob/{git_commit}"
...
def linkcode_resolve(domain, info):
    ...
    if file.parts[0] != "librarytemplate":
